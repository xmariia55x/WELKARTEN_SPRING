                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="input-group input-group-lg">
                                        ...
                                        <form:input path="nombre" class="form-control" id="filtroCreadorEventos"
                                                    name="filtroCreadorEventos"></form:input>
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                Precio Maximo : <form:input path="precio" class="form-control"
                                                                            id="filtroCreadorEventos"
                                                                            name="filtroCreadorEventos"></form:input>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                Aforo Maximo : <form:input path="aforo" class="form-control"
                                                                           id="filtroCreadorEventos"
                                                                           name="filtroCreadorEventos"></form:input>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <form:options items="${creadores}" itemLabel="nombre"
                                        ...
                                        <div class="row">
                                            <button type="submit" class="btn btn-primary" style="width: 20%">Buscar
                                            </button>
                                        </div>
                                    </div>
            ...
            %>
                ...
                <div class="carta">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><%=e.getTitulo()%>
                            </h5>
                            <p class="card-text"><%=e.getLugar()%>
                            </p>
                            <p class="card-text"><%=formatoFecha.format(e.getFechaInicio()) + " " + formatoHora.format(e.getHora())%>
                            </p>
